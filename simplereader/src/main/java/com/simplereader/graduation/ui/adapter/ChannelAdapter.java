...
import com.simplereader.graduation.listener.OnChannelDragListener;
import com.simplereader.graduation.model.Channel;
                        ...
                        .setOnLongClickListener(R.id.rlItemView, new View.OnLongClickListener() {
                            ...
                            public boolean onLongClick(View v) {
                                if (!mIsEdit) {
                                    //开启编辑模式
                                    startEditMode(true);
                                    mEditViewHolder.setText(R.id.tvEdit, mContext.getString(R.string.done));
                                }
                ...
                baseViewHolder.setText(R.id.tvChannel, channel.Title).setOnClickListener(R.id.ivDelete, new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (mRecyclerView.indexOfChild(targetView) >= 0 && otherFirstPosition != -1) {
                            ...
                            int myChannelSize = getMyChannelSize();//这里为了偷懒 ，算出来我的频道的大小
